...
- Started: 2026-07-11 22:42:15
- Git commit: `9a52444746877fb33c862b74ce43975698044e8d`

## CLI args

- `output_dir`: checkpoints/p3_alive_1p0_20260711_224210
- `num_timesteps`: 150000000
- `num_envs`: None
- `env`: joystick
- `task`: flat_terrain
- `restore_checkpoint_path`: None
- `config_overrides`: {"reward_config.scales.alive": 1.0, "reward_config.scales.tracking_lin_vel": 3.0, "reward_config.scales.tracking_ang_vel": 1.0, "reward_config.tracking_sigma_lin": 0.025, "reward_config.tracking_sigma_ang": 2.0}
