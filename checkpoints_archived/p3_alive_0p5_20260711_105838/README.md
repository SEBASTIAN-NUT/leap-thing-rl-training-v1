...
- Started: 2026-07-11 10:58:43
- Git commit: `9a52444746877fb33c862b74ce43975698044e8d`

## CLI args

- `output_dir`: checkpoints/p3_alive_0p5_20260711_105838
- `num_timesteps`: 150000000
- `num_envs`: None
- `env`: joystick
- `task`: flat_terrain
- `restore_checkpoint_path`: None
- `config_overrides`: {"reward_config.scales.alive": 0.5, "reward_config.scales.tracking_lin_vel": 3.0, "reward_config.scales.tracking_ang_vel": 1.0, "reward_config.tracking_sigma_lin": 0.025, "reward_config.tracking_sigma_ang": 2.0}
