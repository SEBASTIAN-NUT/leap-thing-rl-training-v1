...
- Started: 2026-07-07 17:53:22
- Git commit: `14eec46acfba8ffcb9288cb5ed5f7efc89a747c1` (uncommitted changes present)

## CLI args

- `output_dir`: checkpoints/p2_siggang_0p25_20260707_175317
- `num_timesteps`: 45875200
- `num_envs`: None
- `env`: joystick
- `task`: flat_terrain
- `restore_checkpoint_path`: None
- `config_overrides`: {"reward_config.tracking_sigma_lin": 0.025, "reward_config.tracking_sigma_ang": 0.25}
