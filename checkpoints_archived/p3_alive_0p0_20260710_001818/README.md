...
- Started: 2026-07-10 00:18:23
- Git commit: `14eec46acfba8ffcb9288cb5ed5f7efc89a747c1` (uncommitted changes present)

## CLI args

- `output_dir`: checkpoints/p3_alive_0p0_20260710_001818
- `num_timesteps`: 150000000
- `num_envs`: None
- `env`: joystick
- `task`: flat_terrain
- `restore_checkpoint_path`: None
- `config_overrides`: {"reward_config.scales.alive": 0.0, "reward_config.scales.tracking_lin_vel": 3.0, "reward_config.scales.tracking_ang_vel": 1.0, "reward_config.tracking_sigma_lin": 0.025, "reward_config.tracking_sigma_ang": 2.0}
